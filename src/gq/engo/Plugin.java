...
import gq.engo.runnables.TablistRunnable;
...
public class Plugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        Bukkit.getScheduler().runTaskTimer(this, new TablistRunnable(), 0, 20L);

        Boolean vanish = Plugin.Instance.getConfig().getBoolean("Commands.List.Vanish");
        Boolean kill = Plugin.Instance.getConfig().getBoolean("Commands.List.Kill");
        Boolean discord = Plugin.Instance.getConfig().getBoolean("Commands.List.Discord");
        Boolean gettps = Plugin.Instance.getConfig().getBoolean("Commands.List.TPS");
        Boolean help = Plugin.Instance.getConfig().getBoolean("Commands.List.Help");
        Boolean uniquejoins = Plugin.Instance.getConfig().getBoolean("Commands.List.UniqueJoins");
        Boolean say = Plugin.Instance.getConfig().getBoolean("Commands.List.Say");
        Boolean stats = Plugin.Instance.getConfig().getBoolean("Commands.List.Stats");
        Boolean dupe = Plugin.Instance.getConfig().getBoolean("Commands.List.Dupe");
